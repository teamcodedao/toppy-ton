...
export default function Home() {
  return (
    <main className='min-h-screen'>
      {/* Section */}
      <div>
        <div className='relative pt-20 mx-auto max-w-screen-2xl px-5'>
          ...
          <img
            src='/planes.svg'
            alt=''
            className='absolute top-0 left-0 img-planes z-0'
          />
          <img
            src='/planes.svg'
            alt=''
            className='absolute top-0 right-0 scale-x-[-1] img-planes z-0'
          />
        </div>
        <Image
          src={grassImg}
